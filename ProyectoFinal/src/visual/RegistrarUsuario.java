...
public class RegistrarUsuario extends JDialog {
	...
	public RegistrarUsuario(User miusuario) {
		...
		cmbtipo.setModel(new DefaultComboBoxModel(new String[] {"<Seleccionar>", "Basico", "Administrador"}));
	...
	private void registrarUsuario() {
		...
		Organizadora.getInstance().AgregarUser(aux);
